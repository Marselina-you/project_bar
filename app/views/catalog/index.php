...
include ROOT.'/views/layouts/header.php';?>
 ...
 foreach ($extras as $extrasItem): ?>
                           <div class="d-flex justify-content-center align-items-center">
                <div class="menu-products__item justify-content-center"><a href="" data-id="<?php echo $extrasItem['id'];?>" class="clickExtras size18px whitecolor fontSans">
                                        <?php echo $extrasItem['name'];?>
                                        </a></div>
                                   
                        <?php endforeach;?> 
</div></div> <?php foreach ($latestExtras as $extras): ?><div class="nown">
